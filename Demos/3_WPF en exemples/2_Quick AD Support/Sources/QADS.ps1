					...
					<Border BorderBrush="DodgerBlue" BorderThickness="1">			
						<StackPanel Orientation="Vertical"  Margin="10,10,10,10">
							...
							<StackPanel Orientation="Horizontal"  Margin="0,10,0,0" >
								...
								<PasswordBox Name="Admin_Password"  Width="150" />	
							</StackPanel>		
...
$About_Date.Content = "Release date: 10/16/2018"
...
# Function Update_progressBar {
    # param(
    # [String]$script:ProgressStep
    # )
    # $syncProgress.ProgressRing.Dispatcher.Invoke("Normal",[action]{
    # $syncProgress.Label.Content=$script:ProgressStep
    # })
# }		
...
$Menu_Admin.Add_Click({
	...
	$admin_user.Text = $Admin_User_Name
	$admin_password.password = ""
	...
	Else
		{
			...
			Catch 
				{
					[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Admin_Window, "Oops :-(", "Admin password has not been setted successfully")				
				}		
		}
					...
					If($result -eq "Affirmative")
						{
							...
							Catch
								{							
									[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Users_Window, "Oops :-(", "Can not change the password. Check your rights !!!")
								}									
						}					
				}
			Else
			...
			If($result -eq "Affirmative")
				{
					...
					Catch
						{							
							[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Users_Window, "Oops :-(", "Can not disable the account. Check your rights !!!")											
						}
				}
			Else
				{
			...
			If($result -eq "Affirmative")
				{
					...
					Catch
						{													
							[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Users_Window, "Oops :-(", "Can not enable the account. Check your rights !!!")													
						}								
				}
			Else
				{
			...
			If($result -eq "Affirmative")
				{
					...
					Catch
						{
							[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Computers_Window, "Oops :-(", "Can not disable the account. Check your rights !!!")																			
						}
				}
			Else
				{
			...
			If($result -eq "Affirmative")
				{
					...
					Catch
						{
							[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Computers_Window, "Oops :-(", "Can not enable the account. Check your rights !!!")																									
						}
				}
			Else
				{
	...
	If($result -eq "Affirmative")
		{
			...
			Catch
				{							
					[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Users_Window, "Oops :-(", "Can not delete the account. Check your rights !!!")													
				}							
		}
	Else
		{
	...
	If($result -eq "Affirmative")
		{
			...
			Catch
				{							
					[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Computers_Window, "Oops :-(", "Can not delete the account. Check your rights !!!")													
				}						
		}
	Else
		{
	...
	If($result -eq "Affirmative")
		{
			...
			Catch
				{
					[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Users_Window, "Oops :-(", "Can not unlock the account $User. Check your rights !!!")													
				}	
		}
	Else
		{
	...
	If($result -eq "Affirmative")
		{
			...
			Catch
				{
					[MahApps.Metro.Controls.Dialogs.DialogManager]::ShowMessageAsync($Computers_Window, "Oops :-(", "Can not unlock the account $computer. Check your rights !!!")													
				}	
		}
	Else
		{
